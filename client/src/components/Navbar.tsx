...
//         {/* Logo */}
//         <Link href="/" className="text-xl font-bold flex items-center gap-2">
//           🩸 <Translate text="DonorBridgeConnect" />
//         </Link>
...
//             {loginOpen && (
//               <div className="absolute right-0 mt-2 w-56 bg-white text-red-700 rounded-lg shadow-lg overflow-hidden z-50">
//                 <Link
//                   href="/login/patient"
//                   className="block px-4 py-3 hover:bg-red-100"
//                 >
//                   <Translate text="Patient Login" />
//                 </Link>
//                 <Link
//                   href="/login/organization"
//                   className="block px-4 py-3 hover:bg-red-100"
//                 >
//                   <Translate text="Organization Login" />
//                 </Link>
//                 <Link
//                   href="/login/donor"
//                   className="block px-4 py-3 hover:bg-red-100"
//                 >
//                   <Translate text="Donor Login" />
//                 </Link>
//                 <Link
//                   href="/login/blood-bank"
//                   className="block px-4 py-3 hover:bg-red-100"
//                 >
//                   <Translate text="Blood Bank Login" />
//                 </Link>
//               </div>
//             )}
//           </li>
