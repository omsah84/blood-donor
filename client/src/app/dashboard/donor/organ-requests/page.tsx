...
const DonerOrganizationRequestWithModal = () => {
  ...
  useEffect(() => {
    ...
    if (user) {
      ...
      if (parsed.role === "donor") setUserId(parsed.id); // 👈 changed here
    }
  }, []);
...
export default DonerOrganizationRequestWithModal;
